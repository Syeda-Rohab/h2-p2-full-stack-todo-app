    ...
    return (
      <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center">
          <motion.div
            className="w-20 h-20 mx-auto mb-6 border-4 border-blue-900 border-t-blue-700 rounded-full"
            animate={{ rotate: 360 }}
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            >
              <div className="relative group">
                <div className="absolute -inset-2 bg-gradient-to-r from-blue-900/40 to-blue-800/40 rounded-2xl blur-lg opacity-60 group-hover:opacity-100 transition duration-500" />
                <div className="relative bg-gradient-to-br from-[#000510] to-[#00080f] px-8 py-4 rounded-2xl border-2 border-blue-900/40">
                  <h1 className="text-3xl font-black tracking-tight">
                    ...
                    <span className="text-white ml-3 text-2xl">AI</span>
                  </h1>
                </div>
              </div>
              <Link
                href="/"
                className="group text-blue-300 hover:text-blue-200 transition-colors"
              >
                <div className="bg-[#00080f]/60 group-hover:bg-[#000c15]/80 border-2 border-blue-900/40 group-hover:border-blue-800/60 rounded-xl p-3 transition-all">
            ...
            <motion.button
              ...
              className="group relative px-8 py-3 font-black text-white rounded-2xl overflow-hidden transition-all duration-300 hover:scale-105 shadow-2xl shadow-red-900/50"
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-red-900 via-red-800 to-red-900 opacity-0 group-hover:opacity-100 blur-2xl transition-opacity duration-500" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-[#00080f]/90 to-[#000510]/90 p-8 rounded-3xl border-2 border-blue-900/40 backdrop-blur-2xl">
            <div className="flex items-center mb-6">
              <div className="bg-gradient-to-r from-blue-900 to-blue-800 p-3 rounded-xl mr-4">
                <svg className="h-6 w-6 text-blue-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 4v16m8-8H4" />
                </svg>
              </div>
              <h3 className="text-3xl font-black text-white">Create New Task</h3>
            </div>
            <form onSubmit={handleCreateTask} className="space-y-5">
              <div>
                <input
                  ...
                  className="w-full px-6 py-4 bg-[#00080f]/80 border-2 border-blue-900/40 rounded-xl text-white placeholder-blue-300/30 focus:outline-none focus:border-blue-700/60 focus:bg-[#000c15]/90 transition-all backdrop-blur-sm font-medium"
              ...
              <div>
                <textarea
                  ...
                  className="w-full px-6 py-4 bg-[#00080f]/80 border-2 border-blue-900/40 rounded-xl text-white placeholder-blue-300/30 focus:outline-none focus:border-blue-700/60 focus:bg-[#000c15]/90 transition-all backdrop-blur-sm resize-none font-medium"
              ...
              <motion.button
                type="submit"
                className="group relative px-8 py-4 text-white font-black text-lg rounded-2xl overflow-hidden transition-all shadow-2xl shadow-blue-900/50"
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-[#00080f]/90 to-[#000510]/90 p-8 rounded-3xl border-2 border-blue-900/40 backdrop-blur-2xl">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-3xl font-black text-white">Your Tasks <span className="text-blue-400">({tasks.length})</span></h3>
            </div>
